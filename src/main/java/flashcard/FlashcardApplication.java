...
public final class FlashcardApplication {
    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            System.err.println("Алдаа: " + exception.getMessage());
            System.err.println();
        ...
        try {
            ...
            System.err.println("Картуудыг ачаалж чадсангүй: " + exception.getMessage());
            System.exit(1);
            return;
        }
        ...
        try {
            ...
            System.err.println("Сесс явуулах үед I/O алдаа гарлаа: " + exception.getMessage());
            System.exit(1);
        }
    }
